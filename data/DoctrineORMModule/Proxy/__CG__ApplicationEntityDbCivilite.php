 ...
 */
class Civilite extends \Application\Entity\Db\Civilite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'libelleCourt', 'libelleLong', 'sexe', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Civilite $proxy) {
