...
class SaisieForm extends AbstractViewHelper
{
    ...
    public function renderVolumeHoraire($fieldset)
    {
        ...
        if ($inRealise) {
            $res .= '<div><label>&nbsp;</label><br /><br /><button type="button" class="btn btn-default prevu-to-realise" title="Initialise le formulaire avec les heures prévues">Prévu <span class="fas fa-arrow-right"></span> réalisé</button>';
