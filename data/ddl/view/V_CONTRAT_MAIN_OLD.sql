CREATE OR REPLACE FORCE VIEW V_CONTRAT_MAIN_OLD AS
WITH hs AS (
...
FROM (  SELECT c.*,
               ...
               tr.id                                                                                                                                        "tauxId",
               tr.libelle                                                                                                                                   "tauxNom",
               tblc.taux_Remu_Majore_Valeur                                                                                                 "tauxMajoreHoraireValeur",
               to_char(tblc.taux_Remu_Majore_Date, 'dd/mm/YYYY')                                                                                            "tauxMajoreHoraireDate",
               trm.id                                                                                                                                       "tauxMajoreId",
