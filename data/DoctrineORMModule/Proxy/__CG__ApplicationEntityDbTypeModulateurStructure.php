 ...
 */
class TypeModulateurStructure extends \Application\Entity\Db\TypeModulateurStructure implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'validiteDebut', 'validiteFin', 'id', 'histoModificateur', 'histoDestructeur', 'histoCreateur', 'typeModulateur', 'structure');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeModulateurStructure $proxy) {
