 ...
 */
class MotifModificationService extends \Application\Entity\Db\MotifModificationService implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MotifModificationService $proxy) {
