 ...
 */
class TypeCentreCout extends \Application\Entity\Db\TypeCentreCout implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'code', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'histoCreation', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'histoDestruction', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'histoModification', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'libelle', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'histoModificateur', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'histoDestructeur', '' . "\0" . 'Application\\Entity\\Db\\TypeCentreCout' . "\0" . 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeCentreCout $proxy) {
