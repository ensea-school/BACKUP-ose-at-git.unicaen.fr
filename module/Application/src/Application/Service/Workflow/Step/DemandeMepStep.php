...
class DemandeMepStep extends Step
{
    ...
    {
        $labels       = array(
            IntervenantPermanentRole::ROLE_ID => "Je visualise les demandes de mise en paiement me concernant",
            IntervenantExterieurRole::ROLE_ID => "Je visualise les demandes de mise en paiement me concernant",
            ComposanteRole::ROLE_ID           => "J'accède aux demandes de mise en paiement",
            'default'                         => "Demande de mise en paiement",
        );
        $descriptions = array(
