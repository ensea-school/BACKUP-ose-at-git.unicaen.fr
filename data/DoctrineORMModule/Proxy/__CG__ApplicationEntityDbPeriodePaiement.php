 ...
 */
class PeriodePaiement extends \Application\Entity\Db\PeriodePaiement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'validiteDebut', 'validiteFin', 'ordre', 'id', 'typeIntervenant', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PeriodePaiement $proxy) {
