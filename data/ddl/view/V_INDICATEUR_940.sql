...
FROM
  ...
  LEFT JOIN formule_resultat_service frs ON frs.id = tp.formule_res_service_id
  LEFT JOIN formule_resultat_service_ref frsr ON frsr.id = tp.formule_res_service_ref_id
