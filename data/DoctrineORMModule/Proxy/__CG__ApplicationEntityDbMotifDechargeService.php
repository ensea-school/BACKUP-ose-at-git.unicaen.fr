 ...
 */
class MotifDechargeService extends \Application\Entity\Db\MotifDechargeService implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'libelle', 'id', 'historique');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MotifDechargeService $proxy) {
