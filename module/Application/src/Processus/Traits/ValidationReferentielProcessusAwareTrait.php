...
{
    protected ?ValidationReferentielProcessus $processusValidationReferentiel;



    /**
     * @param ValidationReferentielProcessus|null $processusValidationReferentiel
     *
     * @return self
     */
    ...
    {
        if (!$this->processusValidationReferentiel){
