 ...
 */
class TypeFormation extends \Application\Entity\Db\TypeFormation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'libelleCourt', 'libelleLong', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'source', 'histoModificateur', 'histoDestructeur', 'histoCreateur', 'groupe');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeFormation $proxy) {
