 ...
 */
class Validation extends \Application\Entity\Db\Validation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Validation $proxy) {
    ...
    public function setTypeValidation(\Application\Entity\Db\TypeValidation $typeValidation = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeValidation', array($typeValidation));

        return parent::setTypeValidation($typeValidation);
    }
    ...
    public function getTypeValidation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeValidation', array());

        return parent::getTypeValidation();
    }
    ...
    public function setDateCommissionRecherche(\DateTime $dateCommissionRecherche = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateCommissionRecherche', array($dateCommissionRecherche));

        return parent::setDateCommissionRecherche($dateCommissionRecherche);
    }
