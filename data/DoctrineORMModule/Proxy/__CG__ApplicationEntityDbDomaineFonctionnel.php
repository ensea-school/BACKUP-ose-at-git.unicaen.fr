 ...
 */
class DomaineFonctionnel extends \Application\Entity\Db\DomaineFonctionnel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'histoCreation', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'histoDestruction', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'histoModification', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'libelle', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'sourceCode', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'source', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'histoModificateur', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'histoDestructeur', '' . "\0" . 'Application\\Entity\\Db\\DomaineFonctionnel' . "\0" . 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DomaineFonctionnel $proxy) {
