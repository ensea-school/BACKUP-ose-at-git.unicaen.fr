 ...
 */
class CentreCout extends \Application\Entity\Db\CentreCout implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CentreCout $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setParent(\Application\Entity\Db\CentreCout $parent = NULL)
    {
