/* ====================================================================================================
	...
	OSE.UM_STATUT					-- table annualisée des statuts des intervenants
	------------------------------------
	
	-- v1.8 02/12/19 - MYP : UM_STRUCTURE renommage tem_manu en eotp_DU_defaut + eotp_DN_defaut	 
    -- v2.0 12/20 à 03/21 - MYP : adaptations V15 pour adresses
	-- v2.2 27/08/21 - MAS/MYP : CODE EMPLOYEUR PROVENANT D'OREC
	-- v3.0 30/05/22 - MYP : UM_STATUT_INTERVENANT => UM_STATUT annualisée + UM_TRANSFERT_INDIVIDU ajout sexe
=====================================================================================================*/
...
(
  ...
  EMP_SOURCE_CODE 			VARCHAR2(100 CHAR),			-- v2.2
...
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	1,'ENS_CH_UM','Enseignant-chercheur',192,1,9999,1,'ENS Ch'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	2,'ENS_1D','Enseignant premier degré',384,1,9999,1,'ENS 1er'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	3,'ENS_2D','Enseignant second degré',384,1,9999,1,'ENS 2nd'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	4,'ENS_HU','Enseignant-chercheur HU TITU',9999,0,9999,1,'ENS HU'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	5,'DOC_MCE','Doctorant contractuel avec MCE',64,1,64,1,'DOC MCE'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	6,'ENS_ASS','Enseignant associé',192,1,9999,1,'ENS Associé'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	7,'ENS_ASS_50','Enseignant associé mi-temps',96,1,9999,1,'ENS Associé'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	8,'ENS_CTR','Enseignant contractuel',384,1,517,1,'ENS CTR'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	9,'ENS_CTR_50','Enseignant contractuel mi-temps',192,1,325,1,'ENS CTR'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	10,'ENS_CH_CTR','Enseignant-chercheur contractuel',192,1,9999,1,'ENS CTR'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	11,'ENS_CH_CTR_50','Enseignant-chercheur contractuel mi-temps',96,0,96,1,'ENS CTR'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	12,'ATER_UM','ATER',192,0,192,1,'ATER'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	13,'ATER_50','ATER mi-temps',96,0,96,1,'ATER 50%'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	14,'ENS_HU_CTR','Enseignant-chercheur HU CTR',9999,0,9999,1,'ENS HU CTR'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	15,'MLV','Maîtres de langues',192,1,9999,1,'MLV'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	16,'LECT','Lecteur',200,1,9999,1,'LECT'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	17,'INF_ORIEN_EDU','Personnel d''éducation et d''orientation ',384,1,9999,1,'Inf/Orien/Edu'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	18,'SPART','Service partagé',192,1,9999,1,'SPART'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	19,'MAD_1D','MAD premier degré',384,1,9999,1,'MAD ou PFA'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	20,'MAD_2D','MAD second degré',384,1,9999,1,'MAD ou PFA'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	21,'PFA','PFA',384,1,9999,1,'MAD ou PFA'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	22,'CONV','Enseignant avec convention entrante',384,1,9999,1,'CONV'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	23,'CEV_TIT_R','CEV TITU Rémunéré',0,1,9999,2,'IE FP'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	24,'CEV_TIT_G','CEV TITU Titre gracieux',0,1,9999,2,'IE FP'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	25,'CEV_NTIT_R','CEV NTITU Rémunéré',0,1,187,2,'IE Hors FP'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	26,'CEV_NTIT_G','CEV NTITU Titre gracieux',0,1,187,2,'IE Hors FP'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	27,'ATV_R','ATV Rémunéré',0,1,96,2,'ATV'	);
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	28,'ATV_G','ATV Titre gracieux',0,1,96,2,'ATV'	);
-- 18/09/2018
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	29,'ENS_MADE','Enseignant en mise à dispo entrante',192,1,9999,1,'ENS Ch'	);
-- 13/12/2018 modif 11/01/2019
insert into OSE.UM_STATUT_INTERVENANT (ID, CODE_STATUT,LIBELLE, SERVICE_STATUTAIRE, DEPASSEMENT, MAXIMUM_HETD, TYPE_INTERVENANT_ID, PROSE_LIB_STATUT) VALUES (	30,'CONV_MCE','Doctorant contractuel hors UM avec MCE à l''UM (convention)',64,1,64,1,'DOC MCE CONV'	);
