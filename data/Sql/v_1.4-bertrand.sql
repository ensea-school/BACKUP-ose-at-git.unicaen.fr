...
--Insert into WF_ETAPE (ID,CODE,STRUCTURE_DEPENDANT,LIBELLE,PERTIN_FUNC,FRANCH_FUNC,STEP_CLASS,VISIBLE,STRUCTURES_IDS_FUNC,ORDRE) values (WF_ETAPE_id_seq.nextval, 'REFERENTIEL_SAISIE',                 '0',    'Saisie du référentiel',                      'ose_workflow.peut_saisir_referentiel',        'ose_workflow.referentiel_valide',          'Application\Service\Workflow\Step\SaisieReferentielStep',              '1',     null,                                          25);
