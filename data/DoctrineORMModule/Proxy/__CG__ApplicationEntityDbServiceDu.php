 ...
 */
class ServiceDu extends \Application\Entity\Db\ServiceDu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'heures', 'histoCreation', 'histoDestruction', 'histoModification', 'validiteDebut', 'validiteFin', 'id', 'intervenant', 'histoModificateur', 'histoDestructeur', 'histoCreateur', 'annee');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServiceDu $proxy) {
