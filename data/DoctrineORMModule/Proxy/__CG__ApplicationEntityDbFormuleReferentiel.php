 ...
 */
class FormuleReferentiel extends \Application\Entity\Db\FormuleReferentiel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\FormuleReferentiel' . "\0" . 'heures', '' . "\0" . 'Application\\Entity\\Db\\FormuleReferentiel' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\FormuleReferentiel' . "\0" . 'serviceReferentiel', '' . "\0" . 'Application\\Entity\\Db\\FormuleReferentiel' . "\0" . 'structure', '' . "\0" . 'Application\\Entity\\Db\\FormuleReferentiel' . "\0" . 'intervenant', '' . "\0" . 'Application\\Entity\\Db\\FormuleReferentiel' . "\0" . 'fonction', '' . "\0" . 'Application\\Entity\\Db\\FormuleReferentiel' . "\0" . 'annee');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormuleReferentiel $proxy) {
