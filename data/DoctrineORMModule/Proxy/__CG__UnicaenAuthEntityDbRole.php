...
namespace DoctrineORMModule\Proxy\__CG__\UnicaenAuth\Entity\Db;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Role extends \UnicaenAuth\Entity\Db\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'roleId', 'isDefault', 'parent', 'users');
        }
     ...
     * {@inheritDoc}
     */
    public function setParent(\UnicaenAuth\Entity\Db\Role $parent)
    {
