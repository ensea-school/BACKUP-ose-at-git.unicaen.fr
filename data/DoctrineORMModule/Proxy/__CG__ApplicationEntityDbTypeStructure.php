 ...
 */
class TypeStructure extends \Application\Entity\Db\TypeStructure implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'code', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'enseignement', 'validiteDebut', 'validiteFin', 'id', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
