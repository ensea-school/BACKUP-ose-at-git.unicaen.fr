 ...
 */
class TypeDotation extends \Application\Entity\Db\TypeDotation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'histoCreation', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'histoDestruction', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'histoModification', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'libelle', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'paieEtat', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'sourceCode', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'validiteDebut', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'validiteFin', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'source', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'histoModificateur', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'histoDestructeur', '' . "\0" . 'Application\\Entity\\Db\\TypeDotation' . "\0" . 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeDotation $proxy) {
