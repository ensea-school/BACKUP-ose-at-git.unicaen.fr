...
-- Au moyen de jobs Oracle, vous pourrez automatiser le déclenchement de la synchronisation.
-- Exemple de JOB pour la synchronisation des données (mise à jour toutes les 15 minutes)
BEGIN
  DBMS_SCHEDULER.CREATE_JOB (
    job_name => 'OSE_SRC_SYNC',
    job_type => 'STORED_PROCEDURE',
    job_action => 'OSE_IMPORT.SYNCHRONISATION', -- procédure à exécuter
    number_of_arguments => 0,
    start_date => TO_TIMESTAMP_TZ('2017-12-20 14:52:25.835308000 EUROPE/PARIS','YYYY-MM-DD HH24:MI:SS.FF TZR'),
