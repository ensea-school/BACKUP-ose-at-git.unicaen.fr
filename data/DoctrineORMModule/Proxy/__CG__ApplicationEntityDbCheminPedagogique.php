 ...
 */
class CheminPedagogique extends \Application\Entity\Db\CheminPedagogique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'ordre', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'source', 'elementPedagogique', 'histoModificateur', 'histoDestructeur', 'histoCreateur', 'etape');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CheminPedagogique $proxy) {
