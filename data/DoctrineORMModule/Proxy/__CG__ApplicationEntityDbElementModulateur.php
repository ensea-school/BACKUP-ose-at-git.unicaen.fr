 ...
 */
class ElementModulateur extends \Application\Entity\Db\ElementModulateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'id', 'annee', 'modulateur', 'element', 'histoModificateur', 'histoDestructeur', 'histoCreateur', 'remove');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ElementModulateur $proxy) {
    ...
    public function setModulateur(\Application\Entity\Db\Modulateur $modulateur = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setModulateur', array($modulateur));

        return parent::setModulateur($modulateur);
    }
