 ...
 */
class SituationFamiliale extends \Application\Entity\Db\SituationFamiliale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SituationFamiliale $proxy) {
