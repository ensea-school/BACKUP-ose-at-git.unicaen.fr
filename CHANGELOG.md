...
* Adptation des exports de paie (winpaie et siham) pour gérer le paiement des congés payés dans le cadre des missions étudiantes
* Export Ose/Siham : Auto validation de la clôture d'une dossier d'un agent
* Possiblité d'ajouter une centre de coût par défaut au niveau de la structure
...
Veillez bien à retester tous vos états de sortie si vous les avez personnalisé au niveau des requêtes SQL.
