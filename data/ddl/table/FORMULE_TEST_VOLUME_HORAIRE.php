...
return [
    ...
    'columns'     => [
        ...
        'A_NON_PAYABLE_REFERENTIEL'  => [
            'name'        => 'A_NON_PAYABLE_REFERENTIEL',
            'type'        => 'float',
            'bdd-type'    => 'FLOAT',
            'length'      => 0,
            'scale'       => NULL,
        ...
        'C_NON_PAYABLE_REFERENTIEL'  => [
            'name'        => 'C_NON_PAYABLE_REFERENTIEL',
            'type'        => 'float',
            'bdd-type'    => 'FLOAT',
            'length'      => 0,
            'scale'       => NULL,
