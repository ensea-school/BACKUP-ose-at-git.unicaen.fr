 ...
 */
class Modulateur extends \Application\Entity\Db\Modulateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Modulateur $proxy) {
    ...
    public function setTypeModulateur(\Application\Entity\Db\TypeModulateur $typeModulateur = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeModulateur', array($typeModulateur));

        return parent::setTypeModulateur($typeModulateur);
    }
    ...
    public function getTypeModulateur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeModulateur', array());

        return parent::getTypeModulateur();
    }
