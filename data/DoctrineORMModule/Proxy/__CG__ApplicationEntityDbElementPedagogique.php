...
class ElementPedagogique extends \Application\Entity\Db\ElementPedagogique implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'sourceCode', 'tauxFoad', 'tauxFi', 'tauxFc', 'tauxFa', 'fi', 'fc', 'fa', 'validiteDebut', 'validiteFin', 'id', 'cheminPedagogique', 'service', 'structure', 'periode', 'source', 'histoModificateur', 'histoCreateur', 'histoDestructeur', 'etape', 'elementModulateur', 'hasChanged', '' . "\0" . 'Application\\Entity\\Db\\ElementPedagogique' . "\0" . 'typeIntervention', '' . "\0" . 'Application\\Entity\\Db\\ElementPedagogique' . "\0" . 'typeModulateur');
        }
