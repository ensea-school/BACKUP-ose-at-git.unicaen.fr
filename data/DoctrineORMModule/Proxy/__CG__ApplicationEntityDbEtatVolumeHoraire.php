 ...
 */
class EtatVolumeHoraire extends \Application\Entity\Db\EtatVolumeHoraire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'code', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'histoCreation', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'histoDestruction', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'histoModification', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'libelle', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'ordre', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'histoModificateur', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'histoDestructeur', '' . "\0" . 'Application\\Entity\\Db\\EtatVolumeHoraire' . "\0" . 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EtatVolumeHoraire $proxy) {
