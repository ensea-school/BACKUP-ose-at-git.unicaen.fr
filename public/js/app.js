...
function EtapeCentreCout()
{
    ...
    this.setFormValues = function (typeHeuresCode, value)
    {
    ...
    this.getElementEtapeSelect = function (typeHeuresCode)
    {
        return this.element.find('select[name="' + typeHeuresCode + '"]');
    }

    this.getElementElementSelects = function (typeHeuresCode)
    {
        return this.element.find('select[name$="\\[' + typeHeuresCode + '\\]"]');
    }
}
