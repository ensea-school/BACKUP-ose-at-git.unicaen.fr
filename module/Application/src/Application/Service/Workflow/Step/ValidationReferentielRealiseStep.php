 ...
 */
class ValidationReferentielRealiseStep extends Step
{
    public function __construct()
    {
        $labels = [
            IntervenantRole::ROLE_ID => "Je visualise la validation de mon référentiel réalisé",
        ...
        $this
            ...
            ->setRoute('intervenant/validation-referentiel-realise');
    }
}