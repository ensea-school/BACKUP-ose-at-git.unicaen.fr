 ...
 */
class TypeIntervenant extends \Application\Entity\Db\TypeIntervenant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'classToCode', 'code', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'validiteDebut', 'validiteFin', 'id', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeIntervenant $proxy) {
