 ...
 */
class Etablissement extends \Application\Entity\Db\Etablissement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'departement', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'localisation', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'source', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
