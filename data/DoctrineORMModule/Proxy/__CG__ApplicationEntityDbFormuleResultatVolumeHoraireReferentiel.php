 ...
 */
class FormuleResultatVolumeHoraireReferentiel extends \Application\Entity\Db\FormuleResultatVolumeHoraireReferentiel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\FormuleResultatVolumeHoraireReferentiel' . "\0" . 'serviceAssure', '' . "\0" . 'Application\\Entity\\Db\\FormuleResultatVolumeHoraireReferentiel' . "\0" . 'heuresService', '' . "\0" . 'Application\\Entity\\Db\\FormuleResultatVolumeHoraireReferentiel' . "\0" . 'heuresComplReferentiel', '' . "\0" . 'Application\\Entity\\Db\\FormuleResultatVolumeHoraireReferentiel' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\FormuleResultatVolumeHoraireReferentiel' . "\0" . 'formuleResultat', '' . "\0" . 'Application\\Entity\\Db\\FormuleResultatVolumeHoraireReferentiel' . "\0" . 'volumeHoraireReferentiel');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormuleResultatVolumeHoraireReferentiel $proxy) {
