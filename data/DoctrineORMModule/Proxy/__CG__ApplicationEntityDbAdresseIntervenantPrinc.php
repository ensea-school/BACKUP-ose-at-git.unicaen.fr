 ...
 */
class AdresseIntervenantPrinc extends \Application\Entity\Db\AdresseIntervenantPrinc implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'toString', 'batiment', 'codePostal', 'histoCreation', 'histoDestruction', 'histoModification', 'localite', 'mentionComplementaire', 'nomVoie', 'noVoie', 'paysCodeInsee', 'paysLibelle', 'principale', 'sourceCode', 'telDomicile', 'validiteDebut', 'validiteFin', 'ville', 'id', 'intervenant', 'source', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdresseIntervenantPrinc $proxy) {
