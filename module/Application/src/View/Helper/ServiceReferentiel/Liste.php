...
class Liste extends AbstractViewHelper
{
    ...
    public function renderAddButton()
    {
        ...
        if ($this->isInRealise()) {
            ...
            $out     .= '<button type="button" ' . $this->htmlAttribs($attribs) . '>Prévu <span class="fa-solid fa-arrow-right"></span> réalisé</button>&nbsp;';
            ...
            $out     .= '<button type="button" ' . $this->htmlAttribs($attribs) . '>' . $source . ' ' . $this->getServiceContext()->getAnneePrecedente() . ' <span class="fa-solid fa-arrow-right"></span> Prévisionnel ' . $this->getServiceContext()->getAnnee() . '</button>&nbsp;';
        ...
        $out     .= '<a ' . $this->htmlAttribs($attribs) . '><i class="fa-solid fa-plus"></i Je saisis</a>';
...
//        if ($this->getColumnVisibility('heures'       ))  $colspan ++;
    ...
    public function renderShowHide()
    {
        return
            ...
            . '<button type="button" class="btn btn-default btn-xs service-show-all-details"><span class="fa-solid fa-chevron-down"></span> Tout déplier</button> '
            . '<button type="button" class="btn btn-default btn-xs service-hide-all-details"><span class="fa-solid fa-chevron-up"></span> Tout replier</button>'
            . '</div>';
    }
