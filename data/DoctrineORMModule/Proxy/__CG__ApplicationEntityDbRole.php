 ...
 */
class Role extends \Application\Entity\Db\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'structure', 'type', 'source', 'personnel', 'histoDestructeur', 'histoModificateur', 'histoCreateur');
        }
