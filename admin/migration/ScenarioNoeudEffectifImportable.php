...
class ScenarioNoeudEffectifImportable extends AbstractMigration
{
    ...
    public function action(string $contexte)
    {
        ...
        $bdd->exec('ALTER TABLE SCENARIO_NOEUD_EFFECTIF ADD (HISTO_CREATEUR_ID NUMBER)');
        $bdd->exec('ALTER TABLE SCENARIO_NOEUD_EFFECTIF ADD (HISTO_MODIFICATEUR_ID NUMBER)');
        $bdd->exec('ALTER TABLE SCENARIO_NOEUD_EFFECTIF ADD (SOURCE_ID NUMBER)');
