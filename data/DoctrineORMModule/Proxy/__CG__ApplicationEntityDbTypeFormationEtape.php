 ...
 */
class TypeFormationEtape extends \Application\Entity\Db\TypeFormationEtape implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'niveau', 'sourceCode', 'validiteDebut', 'validiteFin', 'etape', 'typeFormation', 'histoModificateur', 'histoDestructeur', 'histoCreateur', 'source');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeFormationEtape $proxy) {
