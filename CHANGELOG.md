...
* Demandes de mises en paiement : il est maintenant possible d'associer à une mise ne paiement un centre de coûts de la composante d'affectation de l'intervenant plutôt que la composante d'enseignement. Un paramétrage général permet de choisir dans quel mode OSE doit fonctionner.
