...
Insert into WF_ETAPE (ID,CODE,STRUCTURE_DEPENDANT,LIBELLE,PERTIN_FUNC,FRANCH_FUNC,STEP_CLASS,VISIBLE) values (WF_ETAPE_id_seq.nextval, 'SERVICE_SAISIE_REALISE',             '0',    'Saisie des enseignements réalisés',        'ose_workflow.peut_saisir_service',            'ose_workflow.possede_services_realises',   'Application\Service\Workflow\Step\SaisieServiceRealiseStep',           '1');
...
Insert into WF_ETAPE (ID,CODE,STRUCTURE_DEPENDANT,LIBELLE,PERTIN_FUNC,FRANCH_FUNC,STEP_CLASS,VISIBLE) values (WF_ETAPE_id_seq.nextval, 'SERVICE_VALIDATION_REALISE',         '1',    'Validation des enseignements réalisés',    'ose_workflow.possede_services_realises',      'ose_workflow.service_realise_valide',      'Application\Service\Workflow\Step\ValidationServiceRealiseStep',       '1');
...
Insert into WF_ETAPE (ID,CODE,STRUCTURE_DEPENDANT,LIBELLE,PERTIN_FUNC,FRANCH_FUNC,STEP_CLASS,VISIBLE) values (WF_ETAPE_id_seq.nextval, 'REFERENTIEL_VALIDATION',             '0',    'Validation du référentiel',                'ose_workflow.possede_referentiel',            'ose_workflow.referentiel_valide',          'Application\Service\Workflow\Step\ValidationReferentielStep',          '1');
Insert into WF_ETAPE (ID,CODE,STRUCTURE_DEPENDANT,LIBELLE,PERTIN_FUNC,FRANCH_FUNC,STEP_CLASS,VISIBLE) values (WF_ETAPE_id_seq.nextval, 'REFERENTIEL_VALIDATION_REALISE',     '0',    'Validation du référentiel réalisé',        'ose_workflow.possede_referentiel_realise',    'ose_workflow.referentiel_realise_valide',  'Application\Service\Workflow\Step\ValidationReferentielRealiseStep',   '1');
