 ...
 */
class DechargeServiceDu extends \Application\Entity\Db\DechargeServiceDu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'heures', 'id', 'motif', 'intervenant', 'annee', 'historique');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DechargeServiceDu $proxy) {
