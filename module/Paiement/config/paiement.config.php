...
return [
    ...
    'service_manager' => [
        'invokables' => [
            \Paiement\Service\ServiceAPayerService::class                      => \Paiement\Service\ServiceAPayerService::class,
            \Paiement\Service\MiseEnPaiementService::class                     => \Paiement\Service\MiseEnPaiementService::class,
            \Paiement\Service\MiseEnPaiementIntervenantStructureService::class => \Paiement\Service\MiseEnPaiementIntervenantStructureService::class,
    ...
    'view_helpers'    => [
        'invokables' => [
            'demandeMiseEnPaiement' => \Paiement\View\Helper\DemandeMiseEnPaiementViewHelper::class,
            'typeHeures'            => \Paiement\View\Helper\TypeHeuresViewHelper::class,
        ],
    ],
    'form_elements'   => [
        'invokables' => [
            \Paiement\Form\Paiement\MiseEnPaiementForm::class => \Paiement\Form\Paiement\MiseEnPaiementForm::class,
            Form\Paiement\MiseEnPaiementRechercheForm::class  => Form\Paiement\MiseEnPaiementRechercheForm::class,
        ],
    ],
    'controllers'     => [
        'invokables' => [
            'Application\Controller\Paiement' => \Paiement\Controller\PaiementController::class,
        ],
    ],
];