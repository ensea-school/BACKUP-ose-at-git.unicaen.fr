 ...
 */
class Personnel extends \Application\Entity\Db\Personnel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'email', 'nomPatronymique', 'nomUsuel', 'prenom', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'source', 'structure', 'civilite', 'role', 'histoCreation', 'histoModification', 'histoDestruction', 'histoCreateur', 'histoModificateur', 'histoDestructeur');
        }
