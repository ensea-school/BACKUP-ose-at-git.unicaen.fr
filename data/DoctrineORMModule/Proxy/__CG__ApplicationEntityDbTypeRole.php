 ...
 */
class TypeRole extends \Application\Entity\Db\TypeRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'code', 'libelle', 'validiteDebut', 'validiteFin', 'id', 'role', 'histoCreation', 'histoModification', 'histoDestruction', 'histoCreateur', 'histoModificateur', 'histoDestructeur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeRole $proxy) {
