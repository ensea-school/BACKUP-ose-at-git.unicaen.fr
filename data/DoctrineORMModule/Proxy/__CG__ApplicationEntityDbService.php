 ...
 */
class Service extends \Application\Entity\Db\Service implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function setStructureAff(\Application\Entity\Db\Structure $structureAff = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStructureAff', array($structureAff));

        return parent::setStructureAff($structureAff);
    }
    ...
    public function setStructureEns(\Application\Entity\Db\Structure $structureEns = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStructureEns', array($structureEns));

        return parent::setStructureEns($structureEns);
    }
