...
* Gestion de la durée de vie des pièces justificatives :
  ...
  * Vous pouvez maintenant préciser combien d'années est valable une pièce justificative
...
* Gestion des agréments
  * La notion de "premier recrutement" disparait au profit de la durée de vie de l'agrément
  * Vous pouvez maintenant préciser combien d'années est valable un agrément
  * 
...
* Reconduction de l'offre de formation
  * une nouvelle interface d'administration vous permet de reporter les modulateurs qui ont été positionnés de l'année en cours à l'année suivante
  * une nouvelle interface d'administration vous permet de reporter les centres de coûts qui ont été positionnés de l'année en cours à l'année suivante
...
Les tableaux de bord doivent être recalculés.
Pensez à recalculer les tableaux de bord au moyen de la commande ./bin/ose calcul-tableaux-bord

En ce qui concerne les pièces justificatives et les agréments, les données demandées uniquement s'il s'agit d'un premier recrutement ont été migrées en données valables 99 ans. A vous de revoir ensuite cette durée de vie si nécessaire.
