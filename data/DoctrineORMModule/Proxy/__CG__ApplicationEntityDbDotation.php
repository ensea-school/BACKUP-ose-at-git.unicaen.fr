 ...
 */
class Dotation extends \Application\Entity\Db\Dotation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'heures', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'histoCreation', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'histoDestruction', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'histoModification', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'structure', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'type', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'histoModificateur', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'histoDestructeur', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'histoCreateur', '' . "\0" . 'Application\\Entity\\Db\\Dotation' . "\0" . 'annee');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Dotation $proxy) {
