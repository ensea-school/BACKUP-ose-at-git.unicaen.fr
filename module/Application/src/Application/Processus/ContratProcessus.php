...
class ContratProcessus extends AbstractProcessus
{
     ...
     * @return Contrat
     */
    public function nouveau(Intervenant $intervenant, Structure $structure)
    {
    ...
    public function valider(Contrat $contrat)
    {
        ...
        if ($contrat->estUnAvenant()){
            ...
            $contrat->setNumeroAvenant($this->getServiceContrat()->getNextNumeroAvenant($contrat->getIntervenant(), false));
        }
