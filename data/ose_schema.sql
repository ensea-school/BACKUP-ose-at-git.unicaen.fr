...
CREATE TABLE "OSE"."DOSSIER" (	
  "ID" NUMBER(*,0) NOT NULL, 
	"NOM_USUEL" VARCHAR2(128 CHAR) NOT NULL, 
	"NOM_PATRONYMIQUE" VARCHAR2(128 CHAR), 
	"PRENOM" VARCHAR2(128 CHAR) NOT NULL, 
	"CIVILITE" VARCHAR2(10 CHAR) NOT NULL, 
	"NUMERO_INSEE" VARCHAR2(20 CHAR) NOT NULL, 
	"ADRESSE" VARCHAR2(1024 CHAR) NOT NULL, 
	"EMAIL" VARCHAR2(128 CHAR) NOT NULL, 
	"TYPE_EMPLOYEUR" VARCHAR2(10 CHAR) NOT NULL, 
	"STATUT" VARCHAR2(10 CHAR) NOT NULL, 
	"RIB" VARCHAR2(50 CHAR) NOT NULL, 
	...
	"HISTO_DESTRUCTEUR_ID" NUMBER(*,0), 
	 CONSTRAINT "DOSSIER_PK" PRIMARY KEY ("ID"),
	 CONSTRAINT "DOSSIER_HCFK" FOREIGN KEY ("HISTO_CREATEUR_ID") REFERENCES "OSE"."UTILISATEUR" ("ID") ENABLE, 
	 CONSTRAINT "DOSSIER_HMFK" FOREIGN KEY ("HISTO_MODIFICATEUR_ID") REFERENCES "OSE"."UTILISATEUR" ("ID") ENABLE, 
	 CONSTRAINT "DOSSIER_HDFK" FOREIGN KEY ("HISTO_DESTRUCTEUR_ID") REFERENCES "OSE"."UTILISATEUR" ("ID") ENABLE
);

ALTER TABLE INTERVENANT_EXTERIEUR ADD (DOSSIER_ID NUMBER(*,0));
ALTER TABLE INTERVENANT_EXTERIEUR ADD CONSTRAINT INTERVENANT_EXTERIEUR_DOSSIER FOREIGN KEY (DOSSIER_ID ) REFERENCES DOSSIER (ID ) enable;

CREATE SEQUENCE DOSSIER_ID_seq INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE ;
