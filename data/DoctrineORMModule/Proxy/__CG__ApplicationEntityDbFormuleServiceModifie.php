 ...
 */
class FormuleServiceModifie extends \Application\Entity\Db\FormuleServiceModifie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormuleServiceModifie $proxy) {
