...
Insert into WF_ETAPE (ID,CODE,STRUCTURE_DEPENDANT,LIBELLE,PERTIN_FUNC,FRANCH_FUNC,STEP_CLASS,VISIBLE) values (WF_ETAPE_id_seq.nextval,'PIECES_JOINTES','0','Pièces justificatives validées','ose_workflow.peut_saisir_piece_jointe','ose_workflow.pieces_jointes_fournies','Application\Service\Workflow\Step\SaisiePiecesJointesStep','1');
...
Insert into WF_ETAPE_TO_ETAPE (DEPART_ETAPE_ID,ARRIVEE_ETAPE_ID) select e1.id, e2.id from WF_ETAPE e1, WF_ETAPE e2 where e1.code = 'SERVICE_SAISIE' and e2.code = 'PIECES_JOINTES';
Insert into WF_ETAPE_TO_ETAPE (DEPART_ETAPE_ID,ARRIVEE_ETAPE_ID) select e1.id, e2.id from WF_ETAPE e1, WF_ETAPE e2 where e1.code = 'PIECES_JOINTES' and e2.code = 'DONNEES_PERSO_VALIDATION';
