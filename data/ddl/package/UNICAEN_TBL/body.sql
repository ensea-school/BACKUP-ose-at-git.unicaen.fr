    ...
    viewQuery := 'SELECT i.annee_id,
            ...
            /*Complétude identité*/
               CASE
                   ...
                   ELSE 0 END    completude_identite,
            /*Complétude identité complémentaire*/
               CASE
                   WHEN si.dossier_identite_comp = 0 THEN 1
                   ELSE
                       CASE
                           WHEN
                               (
            ...
            /*Complétude contact*/
               CASE
                   WHEN si.dossier_contact = 0 THEN 1
                   ELSE
                       (
                           CASE
                               WHEN
                                   (
                                               (CASE
                                                    WHEN si.dossier_email_perso = 1 THEN
                                                        CASE WHEN d.email_perso IS NOT NULL THEN 1 ELSE 0 END
                                                    ELSE
                                                        CASE
                                                            WHEN d.email_pro IS NOT NULL OR d.email_perso IS NOT NULL THEN 1
                                                            ELSE 0 END
                                                   END) = 1
                                           AND
                                               (CASE
                                                    WHEN si.dossier_tel_perso = 1 THEN
            ...
            /*Complétude adresse*/
               CASE
                   WHEN si.dossier_adresse = 0 THEN 1
                   ELSE
                       (
                           CASE
                               WHEN
            ...
            /*Complétude INSEE*/
               CASE
                   WHEN si.dossier_insee = 0 THEN 1
                   ELSE
                       (
                           CASE
                               WHEN
            ...
            /*Complétude employeur*/
               CASE
                   WHEN si.dossier_employeur = 0 THEN 1
                   ELSE
                       (
                           CASE
                               WHEN
