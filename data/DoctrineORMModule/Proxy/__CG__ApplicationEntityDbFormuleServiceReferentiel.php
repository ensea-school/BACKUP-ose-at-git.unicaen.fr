 ...
 */
class FormuleServiceReferentiel extends \Application\Entity\Db\FormuleServiceReferentiel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\FormuleServiceReferentiel' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\FormuleServiceReferentiel' . "\0" . 'serviceReferentiel', '' . "\0" . 'Application\\Entity\\Db\\FormuleServiceReferentiel' . "\0" . 'formuleVolumeHoraireReferentiel', '' . "\0" . 'Application\\Entity\\Db\\FormuleServiceReferentiel' . "\0" . 'intervenant', '' . "\0" . 'Application\\Entity\\Db\\FormuleServiceReferentiel' . "\0" . 'annee', '' . "\0" . 'Application\\Entity\\Db\\FormuleServiceReferentiel' . "\0" . 'structure', '' . "\0" . 'Application\\Entity\\Db\\FormuleServiceReferentiel' . "\0" . 'formuleIntervenant');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormuleServiceReferentiel $proxy) {
    ...
    public function addFormuleVolumeHoraireReferentiel(\Application\Entity\Db\FormuleVolumeHoraireReferentiel $formuleVolumeHoraireReferentiel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addFormuleVolumeHoraireReferentiel', array($formuleVolumeHoraireReferentiel));

        return parent::addFormuleVolumeHoraireReferentiel($formuleVolumeHoraireReferentiel);
    }
    ...
    public function removeFormuleVolumeHoraireReferentiel(\Application\Entity\Db\FormuleVolumeHoraireReferentiel $formuleVolumeHoraireReferentiel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeFormuleVolumeHoraireReferentiel', array($formuleVolumeHoraireReferentiel));

        return parent::removeFormuleVolumeHoraireReferentiel($formuleVolumeHoraireReferentiel);
    }
    ...
    public function getFormuleVolumeHoraireReferentiel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFormuleVolumeHoraireReferentiel', array());

        return parent::getFormuleVolumeHoraireReferentiel();
    }

    /**
     * {@inheritDoc}
     */
    public function getHeures(\Application\Entity\Db\TypeVolumeHoraire $typeVolumeHoraire = NULL, \Application\Entity\Db\EtatVolumeHoraire $etatVolumeHoraire = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHeures', array($typeVolumeHoraire, $etatVolumeHoraire));

        return parent::getHeures($typeVolumeHoraire, $etatVolumeHoraire);
    }
