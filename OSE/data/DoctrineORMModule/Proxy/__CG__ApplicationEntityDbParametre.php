 ...
 */
class Parametre extends \Application\Entity\Db\Parametre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'description', 'histoCreation', 'histoDestruction', 'histoModification', 'nom', 'valeur', 'validiteDebut', 'validiteFin', 'id', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Parametre $proxy) {
