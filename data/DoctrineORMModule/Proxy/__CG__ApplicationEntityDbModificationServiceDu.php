 ...
 */
class ModificationServiceDu extends \Application\Entity\Db\ModificationServiceDu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ModificationServiceDu $proxy) {
