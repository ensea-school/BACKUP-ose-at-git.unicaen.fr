...
class ClotureRealiseStep extends Step
{
    ...
    {
        $labels = [
            IntervenantPermanentRole::ROLE_ID => "Je visualise la clôture de la saisie de mes services réalisés",
            IntervenantExterieurRole::ROLE_ID => "Je visualise la clôture de la saisie de mes services réalisés",
            ComposanteRole::ROLE_ID           => "Je visualise la clôture de la saisie des services réalisés de l'intervenant",
            'default'                         => "Je visualise la clôture de la saisie des services réalisés",
        ];
        $descriptions = [
