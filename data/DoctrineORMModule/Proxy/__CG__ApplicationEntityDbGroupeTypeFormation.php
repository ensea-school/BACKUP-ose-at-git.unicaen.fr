 ...
 */
class GroupeTypeFormation extends \Application\Entity\Db\GroupeTypeFormation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'libelleCourt', 'libelleLong', 'ordre', 'pertinenceNiveau', 'sourceCode', 'id', 'source', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupeTypeFormation $proxy) {
    ...
    public function setPertinenceNiveau($pertinenceNiveau)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPertinenceNiveau', array($pertinenceNiveau));

        return parent::setPertinenceNiveau($pertinenceNiveau);
    }
    ...
    public function getPertinenceNiveau()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPertinenceNiveau', array());

        return parent::getPertinenceNiveau();
    }
