 ...
 */
class VServiceValide extends \Application\Entity\Db\VServiceValide implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\VServiceValide' . "\0" . 'code', 'elementPedagogique', '' . "\0" . 'Application\\Entity\\Db\\VServiceValide' . "\0" . 'heures', 'intervenant', '' . "\0" . 'Application\\Entity\\Db\\VServiceValide' . "\0" . 'libelle', 'service', '' . "\0" . 'Application\\Entity\\Db\\VServiceValide' . "\0" . 'validation', 'volumeHoraire', '' . "\0" . 'Application\\Entity\\Db\\VServiceValide' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VServiceValide $proxy) {
    ...
    public function getElementPedagogiqueId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getElementPedagogiqueId', array());

        return parent::getElementPedagogiqueId();
    }
