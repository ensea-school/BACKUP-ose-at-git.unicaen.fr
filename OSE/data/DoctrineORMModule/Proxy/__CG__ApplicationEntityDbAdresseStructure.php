 ...
 */
class AdresseStructure extends \Application\Entity\Db\AdresseStructure implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'codePostal', 'histoCreation', 'histoDestruction', 'histoModification', 'localite', 'nomVoie', 'noVoie', 'paysCodeInsee', 'paysLibelle', 'principale', 'sourceCode', 'telephone', 'validiteDebut', 'validiteFin', 'ville', 'id', 'structure', 'source', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdresseStructure $proxy) {
