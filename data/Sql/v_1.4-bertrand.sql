...
INTO
  ...
  (
    ...
    'ose_workflow.necessite_agrement_ca',
...
INTO
  ...
  (
    ...
    'ose_workflow.necessite_contrat',
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "OSE"."V_WF_INTERVENANT_ETAPE" ("ID", "NOM_USUEL", "PRENOM", "SOURCE_CODE", "ORDRE", "ETAPE_ID", "LIBELLE", "FRANCHIE", "COURANTE") AS 
