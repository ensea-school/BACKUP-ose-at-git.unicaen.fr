 ...
 */
class Discipline extends \Application\Entity\Db\Discipline implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'libelleCourt', 'libelleLong', 'ordre', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'source', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
