 ...
 */
class UniteEnseignement extends \Application\Entity\Db\UniteEnseignement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'source', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
