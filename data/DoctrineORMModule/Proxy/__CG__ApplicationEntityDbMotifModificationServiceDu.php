 ...
 */
class MotifModificationServiceDu extends \Application\Entity\Db\MotifModificationServiceDu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'code', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'validiteDebut', 'validiteFin', 'id', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MotifModificationServiceDu $proxy) {
