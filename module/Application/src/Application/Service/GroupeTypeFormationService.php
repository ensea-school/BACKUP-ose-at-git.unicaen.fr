...
<meta content="module/Application/src/Application/Service/GroupeTypeFormationService.php · master · open-source / OSE" property="og:title">
...
<meta content="https://git.unicaen.fr/open-source/OSE/blob/master/module/Application/src/Application/Service/GroupeTypeFormationService.php" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="module/Application/src/Application/Service/GroupeTypeFormationService.php · master · open-source / OSE" property="twitter:title">
...
<title>module/Application/src/Application/Service/GroupeTypeFormationService.php · master · open-source / OSE · GitLab</title>
...
<meta name="csrf-token" content="nfJ6nYbYRMeH5WXPvRihMjj1N8KBKKBzhrMG1epSBgF7mDjkEmPRX3tWk9/2kKRxwBgqIrIAmozr7K3PDJiYaw==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/open-source/OSE/blob/master/module/Application/src/Application/Service/GroupeTypeFormationService.php">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="module/Application/src/Application/Service/GroupeTypeFormationService.php" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/open-source/OSE/blob/master/module/Application/src/Application/Service/GroupeTypeFormationService.php"><strong>GroupeTypeFormationService.php</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/open-source/OSE/blame/master/module/Application/src/Application/Service/GroupeTypeFormationService.php">Blame</a><a class="btn" href="/open-source/OSE/commits/master/module/Application/src/Application/Service/GroupeTypeFormationService.php">History</a><a class="btn js-data-file-blob-permalink-url" href="/open-source/OSE/blob/884f3d8b92fdf8bebc0d29be4778d784fced015a/module/Application/src/Application/Service/GroupeTypeFormationService.php">Permalink</a></div>
</div>
</div>
...
GroupeTypeFormationService.php
</strong>
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;module/Application/src/Application/Service/GroupeTypeFormationService.php&quot;,&quot;gfm&quot;:&quot;`module/Application/src/Application/Service/GroupeTypeFormationService.php`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button>
<small>
595 octets
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;6cfa9c9b3bf4b3d8452ef3aa564ee7e3f44073ca&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/open-source/OSE/raw/master/module/Application/src/Application/Service/GroupeTypeFormationService.php"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="module/Application/src/Application/Service/GroupeTypeFormationService.php" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/open-source/OSE/raw/master/module/Application/src/Application/Service/GroupeTypeFormationService.php?inline=false"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#download"></use></svg></a></div>
<div class="btn-group" role="group"><a class="btn js-edit-blob  btn-sm" href="/open-source/OSE/edit/master/module/Application/src/Application/Service/GroupeTypeFormationService.php">Éditer</a><a class="btn btn-default btn-sm" href="/-/ide/project/open-source/OSE/edit/master/-/module/Application/src/Application/Service/GroupeTypeFormationService.php">EDI Web</a><button name="button" type="submit" class="btn btn-default" data-target="#modal-upload-blob" data-toggle="modal">Replace</button><button name="button" type="submit" class="btn btn-remove" data-target="#modal-remove-blob" data-toggle="modal">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-new" rel="nofollow" data-method="post" href="/open-source/OSE/blob/master/module/Application/src/Application/Service/GroupeTypeFormationService.php">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/open-source/OSE/blob/master/module/Application/src/Application/Service/GroupeTypeFormationService.php?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete GroupeTypeFormationService.php</h3>
<button aria-label="Fermer" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/open-source/OSE/blob/master/module/Application/src/Application/Service/GroupeTypeFormationService.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="geUWSWglIQ3vR1K2uoTzm9j/5JO0MU+L/TTeXm9w9Opnj1Qw/J60lRP0pKbxDPbYIBL5c4cZdXSQa3VEibpqgA==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-caa0b04bb6fddc8d6bb78d3537427409">Message de commit
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-caa0b04bb6fddc8d6bb78d3537427409" class="form-control js-commit-message" placeholder="Delete GroupeTypeFormationService.php" required="required" rows="3">
Delete GroupeTypeFormationService.php</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-7ffd3f9ddfb30444f3688986b5634f5c" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-7ffd3f9ddfb30444f3688986b5634f5c">Créer une <strong>nouvelle demande de fusion</strong> avec ces changements
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace GroupeTypeFormationService.php</h3>
<button aria-label="Fermer" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/open-source/OSE/update/master/module/Application/src/Application/Service/GroupeTypeFormationService.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="f1koqlQegV1Nb2YAvTHaOskHeqJ1JD3h5LAB83E3Q0mZM2rTwKUUxbHckBD2ud95MepnQkYMBx6J76rpl/3dIw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-53cd680258a57101e4faa1ce960bc6bb">Message de commit
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-53cd680258a57101e4faa1ce960bc6bb" class="form-control js-commit-message" placeholder="Replace GroupeTypeFormationService.php" required="required" rows="3">
Replace GroupeTypeFormationService.php</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check prepend-top-8">
<input type="checkbox" name="create_merge_request" id="create_merge_request-e9c6629da5b5add1bb35b4d404a703a3" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-e9c6629da5b5add1bb35b4d404a703a3">Créer une <strong>nouvelle demande de fusion</strong> avec ces changements
</label></div>
