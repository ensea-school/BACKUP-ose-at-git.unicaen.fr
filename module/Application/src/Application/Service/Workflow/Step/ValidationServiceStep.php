...
class ValidationServiceStep extends Step
{
    ...
    {
        $labels = array(
            IntervenantPermanentRole::ROLE_ID => "Aller à la validation de mes services par la composante",
            IntervenantExterieurRole::ROLE_ID => "Aller à la validation de mes enseignements par la composante",
            ComposanteRole::ROLE_ID           => "Aller à la validation des services de l'intervenant %s",
        );
        $descriptions = array(
