 ...
 */
class Diplome extends \Application\Entity\Db\Diplome implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'libelle', 'sourceCode', 'id', 'type', 'source', 'historique');
        }
