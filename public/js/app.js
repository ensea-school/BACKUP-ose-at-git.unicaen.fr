$(function ()
{
    ...
    {
        WidgetInitializer.includeJs(unicaenVue.url('ext/vakata-jstree-3.3.8/dist/jstree.min.js'));
        WidgetInitializer.includeCss(unicaenVue.url('ext/vakata-jstree-3.3.8/dist/themes/default/style.min.css'));
    });
