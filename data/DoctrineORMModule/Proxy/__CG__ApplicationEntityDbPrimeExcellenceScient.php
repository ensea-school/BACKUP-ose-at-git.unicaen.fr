 ...
 */
class PrimeExcellenceScient extends \Application\Entity\Db\PrimeExcellenceScient implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrimeExcellenceScient $proxy) {
