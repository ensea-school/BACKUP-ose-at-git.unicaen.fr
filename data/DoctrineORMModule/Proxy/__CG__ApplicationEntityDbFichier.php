 ...
 */
class Fichier extends \Application\Entity\Db\Fichier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\Fichier' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\Fichier' . "\0" . 'nom', '' . "\0" . 'Application\\Entity\\Db\\Fichier' . "\0" . 'taille', '' . "\0" . 'Application\\Entity\\Db\\Fichier' . "\0" . 'type', '' . "\0" . 'Application\\Entity\\Db\\Fichier' . "\0" . 'contenu', '' . "\0" . 'Application\\Entity\\Db\\Fichier' . "\0" . 'description', 'pieceJointe', '' . "\0" . 'Application\\Entity\\Db\\Fichier' . "\0" . 'validation', 'histoCreation', 'histoModification', 'histoDestruction', 'histoCreateur', 'histoModificateur', 'histoDestructeur');
        }
    ...
    public function getTailleToString()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTailleToString', array());

        return parent::getTailleToString();
    }
