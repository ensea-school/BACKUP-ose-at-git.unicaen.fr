<template>
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button :aria-controls="structure.id" :data-bs-target="`#str${structure.id}`" aria-expanded="true"
                    class="accordion-button" data-bs-toggle="collapse" type="button">
...
export default {
    ...
    computed: {
        hasSousStructures: function () {
            return Object.keys(this.structure.structures).length > 0;
        }
    },
    methods: {
        saisie(event)
