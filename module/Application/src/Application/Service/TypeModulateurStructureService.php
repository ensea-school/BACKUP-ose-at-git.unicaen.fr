...
<meta content="module/Application/src/Application/Service/TypeModulateurStructureService.php · master · open-source / OSE" property="og:title">
...
<meta content="https://git.unicaen.fr/open-source/OSE/blob/master/module/Application/src/Application/Service/TypeModulateurStructureService.php" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="module/Application/src/Application/Service/TypeModulateurStructureService.php · master · open-source / OSE" property="twitter:title">
...
<title>module/Application/src/Application/Service/TypeModulateurStructureService.php · master · open-source / OSE · GitLab</title>
...
<meta name="csrf-token" content="4Dg36fdD6SvluBr0S9sw56Uo+3JFTpU8xqEmnHAdYzQGUnWQY/h8sxkL7OQAUzWkXcXmknZmr8Or/o2Gltf9Xg==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/open-source/OSE/blob/master/module/Application/src/Application/Service/TypeModulateurStructureService.php">Repository</a></h2>
</li>
</ul>
</div>
...
<div class="js-signature-container" data-signatures-path="/open-source/OSE/commits/91050a4f24549b507e60ae123021639b80980343/signatures"></div>
...
<input type="hidden" name="path" id="path" value="module/Application/src/Application/Service/TypeModulateurStructureService.php" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/open-source/OSE/tree/master/module/Application/src/Application/Service">Service</a>
</li>
<li class="breadcrumb-item">
<a href="/open-source/OSE/blob/master/module/Application/src/Application/Service/TypeModulateurStructureService.php"><strong>TypeModulateurStructureService.php</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/open-source/OSE/blame/master/module/Application/src/Application/Service/TypeModulateurStructureService.php">Blame</a><a class="btn" href="/open-source/OSE/commits/master/module/Application/src/Application/Service/TypeModulateurStructureService.php">History</a><a class="btn js-data-file-blob-permalink-url" href="/open-source/OSE/blob/884f3d8b92fdf8bebc0d29be4778d784fced015a/module/Application/src/Application/Service/TypeModulateurStructureService.php">Permalink</a></div>
</div>
</div>
...
<li class="commit flex-row js-toggle-container" id="commit-91050a4f">
<div class="avatar-cell d-none d-sm-block">
<a href="/lecluse"><img alt="Laurent Lécluse&#39;s avatar" src="https://secure.gravatar.com/avatar/669ec6efceca1f159791debe6890795b?s=72&amp;d=identicon" class="avatar s36 d-none d-sm-inline" title="Laurent Lécluse" /></a>
</div>
<div class="commit-detail flex-list">
<div class="commit-content qa-commit-content">
<a class="commit-row-message item-title" href="/open-source/OSE/commit/91050a4f24549b507e60ae123021639b80980343">Refactoring nom des services : finalisation</a>
<span class="commit-row-message d-block d-sm-none">
&middot;
91050a4f
</span>
<div class="commiter">
<a class="commit-author-link" href="/lecluse">Laurent Lécluse</a> a créé <time class="js-timeago" title="jan. 9, 2018 12:30pm" datetime="2018-01-09T11:30:18Z" data-toggle="tooltip" data-placement="bottom" data-container="body">jan. 09, 2018</time>
</div>
</div>
<div class="commit-actions flex-row d-none d-sm-flex">

<div class="js-commit-pipeline-status" data-endpoint="/open-source/OSE/commit/91050a4f24549b507e60ae123021639b80980343/pipelines?ref=master"></div>
<div class="commit-sha-group">
<div class="label label-monospace">
91050a4f
</div>
<button class="btn btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copier le condensat SHA du commit" data-class="btn btn-default" data-clipboard-text="91050a4f24549b507e60ae123021639b80980343" type="button" title="Copier le condensat SHA du commit" aria-label="Copier le condensat SHA du commit"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button>
...
TypeModulateurStructureService.php
</strong>
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;module/Application/src/Application/Service/TypeModulateurStructureService.php&quot;,&quot;gfm&quot;:&quot;`module/Application/src/Application/Service/TypeModulateurStructureService.php`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button>
<small>
862 octets
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;a555d31aec60742913a25b8e39cf580668b24897&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/open-source/OSE/raw/master/module/Application/src/Application/Service/TypeModulateurStructureService.php"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="module/Application/src/Application/Service/TypeModulateurStructureService.php" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/open-source/OSE/raw/master/module/Application/src/Application/Service/TypeModulateurStructureService.php?inline=false"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#download"></use></svg></a></div>
<div class="btn-group" role="group"><a class="btn js-edit-blob  btn-sm" href="/open-source/OSE/edit/master/module/Application/src/Application/Service/TypeModulateurStructureService.php">Éditer</a><a class="btn btn-default btn-sm" href="/-/ide/project/open-source/OSE/edit/master/-/module/Application/src/Application/Service/TypeModulateurStructureService.php">EDI Web</a><button name="button" type="submit" class="btn btn-default" data-target="#modal-upload-blob" data-toggle="modal">Replace</button><button name="button" type="submit" class="btn btn-remove" data-target="#modal-remove-blob" data-toggle="modal">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-new" rel="nofollow" data-method="post" href="/open-source/OSE/blob/master/module/Application/src/Application/Service/TypeModulateurStructureService.php">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/open-source/OSE/blob/master/module/Application/src/Application/Service/TypeModulateurStructureService.php?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete TypeModulateurStructureService.php</h3>
<button aria-label="Fermer" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/open-source/OSE/blob/master/module/Application/src/Application/Service/TypeModulateurStructureService.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="zimKaZ0j3OJAxM+5IfhDcldaaJnkatUMNbg8tsYRuHQoQ8gQCZhJerx3OalqcEYxr7d1eddC7/NY55esINsmHg==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-b9866dd807142028a7e57e6549be8ca3">Message de commit
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-b9866dd807142028a7e57e6549be8ca3" class="form-control js-commit-message" placeholder="Delete TypeModulateurStructureService.php" required="required" rows="3">
Delete TypeModulateurStructureService.php</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-7cb93d087c5f1ccb94bd8a4835207937" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-7cb93d087c5f1ccb94bd8a4835207937">Créer une <strong>nouvelle demande de fusion</strong> avec ces changements
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace TypeModulateurStructureService.php</h3>
<button aria-label="Fermer" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/open-source/OSE/update/master/module/Application/src/Application/Service/TypeModulateurStructureService.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="tQha3e/qOp69aBA3Lg92ruf8g4uTyjlgSOqT6i3lvuVTYhike1GvBkHb5idlh3PtHxGea6DiA58ltTjwyy8gjw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-4cb888ea4b9ac418036de7852e1468df">Message de commit
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-4cb888ea4b9ac418036de7852e1468df" class="form-control js-commit-message" placeholder="Replace TypeModulateurStructureService.php" required="required" rows="3">
Replace TypeModulateurStructureService.php</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check prepend-top-8">
<input type="checkbox" name="create_merge_request" id="create_merge_request-0bb19bef6cd8ff01efb588b5bedbe0d3" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-0bb19bef6cd8ff01efb588b5bedbe0d3">Créer une <strong>nouvelle demande de fusion</strong> avec ces changements
</label></div>
