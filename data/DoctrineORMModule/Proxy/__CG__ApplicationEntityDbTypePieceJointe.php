 ...
 */
class TypePieceJointe extends \Application\Entity\Db\TypePieceJointe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypePieceJointe $proxy) {
    ...
    public function setUrlModeleDoc($urlModeleDoc)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUrlModeleDoc', array($urlModeleDoc));

        return parent::setUrlModeleDoc($urlModeleDoc);
    }
    ...
    public function getUrlModeleDoc()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUrlModeleDoc', array());

        return parent::getUrlModeleDoc();
    }
