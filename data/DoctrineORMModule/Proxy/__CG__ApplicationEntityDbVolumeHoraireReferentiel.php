 ...
 */
class VolumeHoraireReferentiel extends \Application\Entity\Db\VolumeHoraireReferentiel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VolumeHoraireReferentiel $proxy) {
    ...
    public function getEtatVolumeHoraireReferentiel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEtatVolumeHoraireReferentiel', array());

        return parent::getEtatVolumeHoraireReferentiel();
    }
     ...
     * {@inheritDoc}
     */
    public function getFormuleResultatVolumeHoraireReferentiel(\Application\Entity\Db\TypeVolumeHoraire $typeVolumeHoraire = NULL, \Application\Entity\Db\EtatVolumeHoraire $etatVolumeHoraire = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFormuleResultatVolumeHoraireReferentiel', array($typeVolumeHoraire, $etatVolumeHoraire));

        return parent::getFormuleResultatVolumeHoraireReferentiel($typeVolumeHoraire, $etatVolumeHoraire);
    }

    /**
     * {@inheritDoc}
     */
    public function getUniqueFormuleResultatVolumeHoraireReferentiel(\Application\Entity\Db\TypeVolumeHoraire $typeVolumeHoraire, \Application\Entity\Db\EtatVolumeHoraire $etatVolumeHoraire)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUniqueFormuleResultatVolumeHoraireReferentiel', array($typeVolumeHoraire, $etatVolumeHoraire));

        return parent::getUniqueFormuleResultatVolumeHoraireReferentiel($typeVolumeHoraire, $etatVolumeHoraire);
    }
