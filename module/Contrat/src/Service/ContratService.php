...
class ContratService extends AbstractEntityService
{
    ...
    public function rafraichirProcessSignatureElectronique(Contrat $contrat): bool
    {
        ...
        if ($contrat instanceof Contrat) {
            ...
            try {
                $fichierContrat = $this->recupererFichier($contrat, $path);
    ...
    public function recupererFichier(Contrat $contrat, $path = null): ?Fichier
    {
        $fichiers = $contrat->getFichier();
        //Si on a un path on dépose le fichier à cette endroit
    ...
    public function supprimerFichiers(Contrat $contrat): Contrat
    {
        if ($contrat instanceof Contrat) {
            ...
            if (!empty($fichiers)) {
                ...
                //unlink($path);
                //Voir pour unlink le fichier physiquement sur le serveur
