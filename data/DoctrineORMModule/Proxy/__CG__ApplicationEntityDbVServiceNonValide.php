 ...
 */
class VServiceNonValide extends \Application\Entity\Db\VServiceNonValide implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'elementPedagogique', '' . "\0" . 'Application\\Entity\\Db\\VServiceNonValide' . "\0" . 'heures', 'intervenant', '' . "\0" . 'Application\\Entity\\Db\\VServiceNonValide' . "\0" . 'libelle', 'service', 'volumeHoraire', '' . "\0" . 'Application\\Entity\\Db\\VServiceNonValide' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VServiceNonValide $proxy) {
