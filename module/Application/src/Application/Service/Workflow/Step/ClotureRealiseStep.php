 ...
 */
class ClotureRealiseStep extends Step
{
    public function __construct()
    {
        $labels = [
            IntervenantPermanentRole::ROLE_ID => "Je visualise la clôture de la saisie de mes enseignements réalisés",
            IntervenantExterieurRole::ROLE_ID => "Je visualise la clôture de la saisie de mes enseignements réalisés",
            ComposanteRole::ROLE_ID           => "Je visualise la clôture de la saisie des enseignements réalisés de l'intervenant",
            'default'                         => "Clôture de la saisie des enseignements réalisés",
        ];
        $descriptions = [
