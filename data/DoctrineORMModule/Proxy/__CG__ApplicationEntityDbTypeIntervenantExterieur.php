 ...
 */
class TypeIntervenantExterieur extends \Application\Entity\Db\TypeIntervenantExterieur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'limiteHeuresComplementaires', 'validiteDebut', 'validiteFin', 'id', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeIntervenantExterieur $proxy) {
    ...
    public function setLimiteHeuresComplementaires($limiteHeuresComplementaires)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLimiteHeuresComplementaires', array($limiteHeuresComplementaires));

        return parent::setLimiteHeuresComplementaires($limiteHeuresComplementaires);
    }
    ...
    public function getLimiteHeuresComplementaires()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLimiteHeuresComplementaires', array());

        return parent::getLimiteHeuresComplementaires();
    }
