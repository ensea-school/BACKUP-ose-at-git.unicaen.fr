...
class Agrement extends \Application\Entity\Db\Agrement implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'intervenantId', 'validiteDebut', 'validiteFin', 'date', 'id', 'histoModificateur', 'intervenantExterieur', 'histoDestructeur', 'histoCreateur', 'annee', 'structure');
        }
