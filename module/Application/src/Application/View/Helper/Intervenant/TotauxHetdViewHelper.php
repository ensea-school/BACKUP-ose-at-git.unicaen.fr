    ...
    public function render()
    {
        ...
        <table class="table table-bordered" style="width:auto;">
            ...
            <?php if ($fr->getHeuresCompl() > 0) : ?>
                ...
                <tr<?php echo $plafond ? ' class="bg-danger"' : '' ?>><th style="padding-left:5em">Dont <abbr title="Rémunération FC au titre de l'article D714-60 du code de l’Éducation">rémunération FC D714-60</abbr></th>
