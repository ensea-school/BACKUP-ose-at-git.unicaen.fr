 ...
 */
class TypeVolumeHoraire extends \Application\Entity\Db\TypeVolumeHoraire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeVolumeHoraire $proxy) {
