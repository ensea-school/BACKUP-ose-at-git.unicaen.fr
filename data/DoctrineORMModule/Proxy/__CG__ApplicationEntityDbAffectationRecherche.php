 ...
 */
class AffectationRecherche extends \Application\Entity\Db\AffectationRecherche implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'source', 'structure', 'intervenant', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AffectationRecherche $proxy) {
