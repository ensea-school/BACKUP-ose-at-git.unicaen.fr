...
{
    const CACHE_KEY = 'Intervenant_Service_StatutService_getStatuts_';
    ...
    public function getStatuts(): array
    {
        if (empty($this->statuts)) {
            ...
            $query->setResultCacheId(self::CACHE_KEY.$annee->getId());
    ...
    public function save($entity)
    {
        ...
        $cacheDriver = $this->getEntityManager()->getConfiguration()->getResultCache();
        $cacheDriver->deleteItem(self::CACHE_KEY.$entity->getAnnee()->getId());
        $this->getSessionContainer()->offsetUnset('privileges' . $entity->getAnnee()->getId());
