 ...
 */
class RegimeSecu extends \Application\Entity\Db\RegimeSecu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'code', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'tauxTaxe', 'validiteDebut', 'validiteFin', 'id', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegimeSecu $proxy) {
    ...
    public function setTauxTaxe($tauxTaxe)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTauxTaxe', array($tauxTaxe));

        return parent::setTauxTaxe($tauxTaxe);
    }
    ...
    public function getTauxTaxe()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTauxTaxe', array());

        return parent::getTauxTaxe();
    }
