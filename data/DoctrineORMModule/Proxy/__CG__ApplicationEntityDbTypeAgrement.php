 ...
 */
class TypeAgrement extends \Application\Entity\Db\TypeAgrement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'code', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'histoCreation', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'histoDestruction', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'histoModification', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'libelle', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'histoModificateur', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'histoDestructeur', '' . "\0" . 'Application\\Entity\\Db\\TypeAgrement' . "\0" . 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeAgrement $proxy) {
