...
<meta content="module/Application/src/Application/Entity/Db/TypeFormation.php · master · open-source / OSE" property="og:title">
...
<meta content="https://git.unicaen.fr/open-source/OSE/blob/master/module/Application/src/Application/Entity/Db/TypeFormation.php" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="module/Application/src/Application/Entity/Db/TypeFormation.php · master · open-source / OSE" property="twitter:title">
...
<title>module/Application/src/Application/Entity/Db/TypeFormation.php · master · open-source / OSE · GitLab</title>
...
<meta name="csrf-token" content="VJcC7Av0IdRkpE9MY/wOs+wXnjeslyxD836hjcWZvYyy/UCVn0+0TJgXuVwodAvwFPqD15+/FryeIQqXI1Mj5g==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/open-source/OSE/blob/master/module/Application/src/Application/Entity/Db/TypeFormation.php">Repository</a></h2>
</li>
</ul>
</div>
...
<div class="js-signature-container" data-signatures-path="/open-source/OSE/commits/e8ea662b9cfb5c21eac43147d249403e726c6c80/signatures"></div>
...
<input type="hidden" name="path" id="path" value="module/Application/src/Application/Entity/Db/TypeFormation.php" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/open-source/OSE/tree/master/module/Application/src/Application/Entity">..</a>
</li>
<li class="breadcrumb-item">
<a href="/open-source/OSE/tree/master/module/Application/src/Application/Entity/Db">Db</a>
</li>
<li class="breadcrumb-item">
<a href="/open-source/OSE/blob/master/module/Application/src/Application/Entity/Db/TypeFormation.php"><strong>TypeFormation.php</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/open-source/OSE/blame/master/module/Application/src/Application/Entity/Db/TypeFormation.php">Blame</a><a class="btn" href="/open-source/OSE/commits/master/module/Application/src/Application/Entity/Db/TypeFormation.php">History</a><a class="btn js-data-file-blob-permalink-url" href="/open-source/OSE/blob/884f3d8b92fdf8bebc0d29be4778d784fced015a/module/Application/src/Application/Entity/Db/TypeFormation.php">Permalink</a></div>
</div>
</div>
...
<li class="commit flex-row js-toggle-container" id="commit-e8ea662b">
...
<a class="commit-row-message item-title" href="/open-source/OSE/commit/e8ea662b9cfb5c21eac43147d249403e726c6c80">Création des champs - Mise à jour des entités</a>
<span class="commit-row-message d-block d-sm-none">
&middot;
e8ea662b
</span>
<div class="commiter">
<a class="commit-author-link" href="/lecluse">Laurent Lécluse</a> a créé <time class="js-timeago" title="mai 22, 2018 3:49pm" datetime="2018-05-22T13:49:23Z" data-toggle="tooltip" data-placement="bottom" data-container="body">mai 22, 2018</time>
</div>
</div>
<div class="commit-actions flex-row d-none d-sm-flex">

<div class="js-commit-pipeline-status" data-endpoint="/open-source/OSE/commit/e8ea662b9cfb5c21eac43147d249403e726c6c80/pipelines?ref=master"></div>
<div class="commit-sha-group">
<div class="label label-monospace">
e8ea662b
</div>
<button class="btn btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copier le condensat SHA du commit" data-class="btn btn-default" data-clipboard-text="e8ea662b9cfb5c21eac43147d249403e726c6c80" type="button" title="Copier le condensat SHA du commit" aria-label="Copier le condensat SHA du commit"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button>
...
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;module/Application/src/Application/Entity/Db/TypeFormation.php&quot;,&quot;gfm&quot;:&quot;`module/Application/src/Application/Entity/Db/TypeFormation.php`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button>
<small>
2,7 ko
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;ec04a0bdca3590663d56ad60d3b3351717678a6f&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/open-source/OSE/raw/master/module/Application/src/Application/Entity/Db/TypeFormation.php"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="module/Application/src/Application/Entity/Db/TypeFormation.php" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/open-source/OSE/raw/master/module/Application/src/Application/Entity/Db/TypeFormation.php?inline=false"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#download"></use></svg></a></div>
<div class="btn-group" role="group"><a class="btn js-edit-blob  btn-sm" href="/open-source/OSE/edit/master/module/Application/src/Application/Entity/Db/TypeFormation.php">Éditer</a><a class="btn btn-default btn-sm" href="/-/ide/project/open-source/OSE/edit/master/-/module/Application/src/Application/Entity/Db/TypeFormation.php">EDI Web</a><button name="button" type="submit" class="btn btn-default" data-target="#modal-upload-blob" data-toggle="modal">Replace</button><button name="button" type="submit" class="btn btn-remove" data-target="#modal-remove-blob" data-toggle="modal">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-new" rel="nofollow" data-method="post" href="/open-source/OSE/blob/master/module/Application/src/Application/Entity/Db/TypeFormation.php">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/open-source/OSE/blob/master/module/Application/src/Application/Entity/Db/TypeFormation.php?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete TypeFormation.php</h3>
<button aria-label="Fermer" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/open-source/OSE/blob/master/module/Application/src/Application/Entity/Db/TypeFormation.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="s23YHY1UFn8hGgv/1RSKLlbGoTnULbvXTHcS4Zzvdh1VB5pkGe+D592p/e+enI9triu82ecFgSghKLn7eiXodw==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-4b18a4cfa3e4862632356361fc0aba67">Message de commit
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-4b18a4cfa3e4862632356361fc0aba67" class="form-control js-commit-message" placeholder="Delete TypeFormation.php" required="required" rows="3">
Delete TypeFormation.php</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-ba8220b32130ba73b12adff07eb50473" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-ba8220b32130ba73b12adff07eb50473">Créer une <strong>nouvelle demande de fusion</strong> avec ces changements
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace TypeFormation.php</h3>
<button aria-label="Fermer" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/open-source/OSE/update/master/module/Application/src/Application/Entity/Db/TypeFormation.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="nbfsjQWkyzn+WxFTzLAaHg+oxeo18/zmO4jAj7pqQ+573a70kR9eoQLo50OHOB9d90XYCgbbxhlW12uVXKDdhA==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-4d8f18575e4eed696eea82c83bf8b3c8">Message de commit
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-4d8f18575e4eed696eea82c83bf8b3c8" class="form-control js-commit-message" placeholder="Replace TypeFormation.php" required="required" rows="3">
Replace TypeFormation.php</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check prepend-top-8">
<input type="checkbox" name="create_merge_request" id="create_merge_request-c7c3036a0393ccf8fd5201ed07105aec" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-c7c3036a0393ccf8fd5201ed07105aec">Créer une <strong>nouvelle demande de fusion</strong> avec ces changements
</label></div>
