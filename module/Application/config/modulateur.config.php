...
<meta content="module/Application/config/modulateur.config.php · master · open-source / OSE" property="og:title">
...
<meta content="https://git.unicaen.fr/open-source/OSE/blob/master/module/Application/config/modulateur.config.php" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="module/Application/config/modulateur.config.php · master · open-source / OSE" property="twitter:title">
...
<title>module/Application/config/modulateur.config.php · master · open-source / OSE · GitLab</title>
...
<meta name="csrf-token" content="7BbDSIqSY4Vfkd3Y36kuEhvmJgG2NWwC+uP5qSkh0H0KfIExHin2HaMiK8iUIStR4ws74YUdVv2XvFKzz+tOFw==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/open-source/OSE/blob/master/module/Application/config/modulateur.config.php">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="module/Application/config/modulateur.config.php" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/open-source/OSE/tree/master/module/Application/config">config</a>
</li>
<li class="breadcrumb-item">
<a href="/open-source/OSE/blob/master/module/Application/config/modulateur.config.php"><strong>modulateur.config.php</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/open-source/OSE/blame/master/module/Application/config/modulateur.config.php">Blame</a><a class="btn" href="/open-source/OSE/commits/master/module/Application/config/modulateur.config.php">History</a><a class="btn js-data-file-blob-permalink-url" href="/open-source/OSE/blob/884f3d8b92fdf8bebc0d29be4778d784fced015a/module/Application/config/modulateur.config.php">Permalink</a></div>
</div>
</div>
...
modulateur.config.php
</strong>
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;module/Application/config/modulateur.config.php&quot;,&quot;gfm&quot;:&quot;`module/Application/config/modulateur.config.php`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button>
<small>
7,3 ko
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;bcd95aec5098bf8367962a3430f517dc49f13f6f&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/open-source/OSE/raw/master/module/Application/config/modulateur.config.php"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="module/Application/config/modulateur.config.php" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/open-source/OSE/raw/master/module/Application/config/modulateur.config.php?inline=false"><svg><use xlink:href="/assets/icons-8887803ae40f1ee57a8952b5e3b080213a686e327d4d971d8e532c862b79990b.svg#download"></use></svg></a></div>
<div class="btn-group" role="group"><a class="btn js-edit-blob  btn-sm" href="/open-source/OSE/edit/master/module/Application/config/modulateur.config.php">Éditer</a><a class="btn btn-default btn-sm" href="/-/ide/project/open-source/OSE/edit/master/-/module/Application/config/modulateur.config.php">EDI Web</a><button name="button" type="submit" class="btn btn-default" data-target="#modal-upload-blob" data-toggle="modal">Replace</button><button name="button" type="submit" class="btn btn-remove" data-target="#modal-remove-blob" data-toggle="modal">Delete</button></div>
</div>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-new" rel="nofollow" data-method="post" href="/open-source/OSE/blob/master/module/Application/config/modulateur.config.php">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/open-source/OSE/blob/master/module/Application/config/modulateur.config.php?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete modulateur.config.php</h3>
<button aria-label="Fermer" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/open-source/OSE/blob/master/module/Application/config/modulateur.config.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="z0tVAf8sUBDn/KuqgO9igxlD96236WGa8Barh+3jqcopIRd4a5fFiBtPXbrLZ2fA4a7qTYTBW2WdSQCdCyk3oA==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-2734de6919f8cdfffd00f468ff5fee44">Message de commit
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-2734de6919f8cdfffd00f468ff5fee44" class="form-control js-commit-message" placeholder="Delete modulateur.config.php" required="required" rows="3">
Delete modulateur.config.php</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-d51ebf504f8e68962d85a8f7652b4d38" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-d51ebf504f8e68962d85a8f7652b4d38">Créer une <strong>nouvelle demande de fusion</strong> avec ces changements
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace modulateur.config.php</h3>
<button aria-label="Fermer" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/open-source/OSE/update/master/module/Application/config/modulateur.config.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="aW2O6uuXapAZUAgI00zmuSK6MlOEHVK83J0Q64yhJYyPB8yTfyz/COXj/hiYxOP62lcvs7c1aEOxwrvxamu75g==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-424856c476907cf378d0d4d2d4482ac2">Message de commit
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-424856c476907cf378d0d4d2d4482ac2" class="form-control js-commit-message" placeholder="Replace modulateur.config.php" required="required" rows="3">
Replace modulateur.config.php</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check prepend-top-8">
<input type="checkbox" name="create_merge_request" id="create_merge_request-3579d760461ac9bad79253bc5f9dfc61" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-3579d760461ac9bad79253bc5f9dfc61">Créer une <strong>nouvelle demande de fusion</strong> avec ces changements
</label></div>
