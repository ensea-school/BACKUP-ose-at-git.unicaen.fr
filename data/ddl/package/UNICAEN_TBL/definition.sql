CREATE OR REPLACE PACKAGE "UNICAEN_TBL" AS
  ...
  PROCEDURE C_CANDIDATURE(useParams BOOLEAN DEFAULT FALSE);
  ...
  PROCEDURE C_PLAFOND_MISSION(useParams BOOLEAN DEFAULT FALSE);
  ...
  PROCEDURE C_PRIME(useParams BOOLEAN DEFAULT FALSE);
