 ...
 */
class PeriodeEnseignement extends \Application\Entity\Db\PeriodeEnseignement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'histoCreation', 'histoDestruction', 'histoModification', 'libelle', 'ordre', 'sourceCode', 'validiteDebut', 'validiteFin', 'id', 'source', 'histoModificateur', 'histoDestructeur', 'histoCreateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PeriodeEnseignement $proxy) {
