...
class EditionContratStep extends Step
{
    ...
    {
        $labels = array(
            IntervenantPermanentRole::ROLE_ID => "Je visualise mon contrat",
            IntervenantExterieurRole::ROLE_ID => "Je visualise mon contrat",
            ComposanteRole::ROLE_ID           => "Je visualise le contrat de l'intervenant %s",
        );
        $descriptions = array(
