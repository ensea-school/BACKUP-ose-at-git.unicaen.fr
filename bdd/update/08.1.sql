...
ALTER TABLE FORMULE_TEST_INTERVENANT DROP COLUMN DEBUG_INFO;
ALTER TABLE FORMULE_TEST_VOLUME_HORAIRE DROP COLUMN DEBUG_INFO;
ALTER TABLE FORMULE_TEST_INTERVENANT ADD (DEBUG_INFO VARCHAR2(4000) );
ALTER TABLE FORMULE_TEST_VOLUME_HORAIRE ADD (DEBUG_INFO VARCHAR2(4000) );
